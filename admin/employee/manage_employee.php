...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h5 class="card-title"><?php echo isset($id) ? "Update Employee's Details - ".$employee_code : 'Add New Details' ?></h5>
    </div>
    <div class="card-body">
        <div class="container-fluid">
            <form action="" id="employee-form">
                ...
                <div class="col-md-12">
                    <fieldset class="border-bottom border-info">
                        ...
                        <div class="row">
                            <div class="form-group col-sm-4">
                                <label for="lastname" class="control-label text-info">Last Name <span class="required-field">*</span></label>
                            ...
                            <div class="form-group col-sm-4">
                                <label for="firstname" class="control-label text-info">First Name <span class="required-field">*</span></label>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-4">
                                <label for="dob" class="control-label text-info">Date of Birth <span class="required-field">*</span></label>
                                <input type="date" class="form-control form-control-sm rounded-0" id="dob" name="dob" value="<?php echo isset($dob) ? $dob : '' ?>" required>
                            </div>
                            <div class="form-group col-sm-4">
                                <label for="contact" class="control-label text-info">Contact <span class="required-field">*</span></label>
                        ...
                        <div class="row">
                            <div class="form-group col-sm-12">
                                <label for="address" class="control-label text-info">Address <span class="required-field">*</span></label>
                        ...
                        <div class="row">
                            <div class="form-group col-sm-4">
                                <label for="email" class="control-label text-info">Email <span class="required-field">*</span></label>
                    ...
                    <fieldset class="border-bottom border-info">
                        <legend class="text-info">Collage Details</legend>
                        <div class="row">
                            <div class="form-group col-sm-4">
                                <label for="department_id" class="control-label text-info">Department <span class="required-field">*</span></label>
                            ...
                            <div class="form-group col-sm-4">
                                <label for="designation_id" class="control-label text-info">Designation <span class="required-field">*</span></label>
                    ...
                    <fieldset class="border-bottom border-info">
                        <legend class="text-info">Profile</legend>
                        <div class="row">
                            <div class="form-group col-sm-4">
